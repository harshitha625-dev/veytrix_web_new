...
import { AdminActivityMonitoringDashboard } from "../../../portals/developer/components/admin-activity-monitoring-dashboard";
import { logSecurityPortalActivity } from "../../../services/security-portal.service";

export function SecurityAdminActivityPage() {
  ...
  useEffect(() => {
    if (profile) {
      logSecurityPortalActivity({
        ...
        action: "Accessed Admin Activity Monitoring",
      }).catch(console.error);
    }
  }, [profile]);
