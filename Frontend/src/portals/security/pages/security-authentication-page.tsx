...
import { AuthenticationMonitoringDashboard } from "../../../portals/developer/components/authentication-monitoring-dashboard";
import { logSecurityPortalActivity } from "../../../services/security-portal.service";

export function SecurityAuthenticationPage() {
  ...
  useEffect(() => {
    if (profile) {
      logSecurityPortalActivity({
        ...
        module: "Authentication Monitoring",
        action: "Accessed Authentication Monitoring",
      }).catch(console.error);
    }
  }, [profile]);
